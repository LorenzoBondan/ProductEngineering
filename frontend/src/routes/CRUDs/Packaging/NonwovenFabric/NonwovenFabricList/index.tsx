                    ...
                    <tbody>
                        {
                            ...
                            .map(tnt => (
                                <tr key={tnt.codigo}>
                                    ...
                                    <td><img onClick={() => handleUpdateClick(tnt.codigo)} className="edit-btn" src={editIcon} alt="Editar" /></td>
                                    <td><img onClick={() => handleDeleteClick(tnt.codigo)} className="delete-btn" src={deleteIcon} alt="Deletar" /></td>
                                </tr>
                            ))
                        }
                    </tbody>
