...
export default function CornerBracketForm() {
    ...
    const isEditing = params.cornerBracketId !== 'create';
    ...
    useEffect(() => {
        if (isEditing) {
            cantoneiraService.pesquisarPorId(Number(params.cornerBracketId))
                .then(response => {
    ...
    function handleSubmit(event: any) {
        ...
        if (isEditing) {
            requestBody.codigo = Number(params.cornerBracketId);
        }

        const request = isEditing
            ? cantoneiraService.atualizar(requestBody)
            : cantoneiraService.criar(requestBody);
