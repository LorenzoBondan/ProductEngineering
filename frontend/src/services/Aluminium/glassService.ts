...
export function findAllActiveAndCurrentOne(id: number) {
    const config : AxiosRequestConfig = {
        method: "GET",
        url: "/glasses/activeAndCurrentOne",
        params: {
            id
        },
        withCredentials: true
...
export function findById(id: number) {
    return requestBackend({ url: `/glasses/${id}`, withCredentials: true });
}

export function insert(obj: DGlass) {
    const config: AxiosRequestConfig = {
        method: "POST",
        url: "/glasses",
        withCredentials: true,
...
export function update(obj: DGlass) {
    const config: AxiosRequestConfig = {
        method: "PUT",
        url: `/glasses/${obj.code}`,
        withCredentials: true,
        data: obj
    }
