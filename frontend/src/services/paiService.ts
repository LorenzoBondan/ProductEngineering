...
export function criar(obj: DPai) {
    const config: AxiosRequestConfig = {
        method: "POST",
        url: `${route}`,
        withCredentials: true,
...
export function criarEstrutura(obj: DMontadorEstruturaPai) {
    const config: AxiosRequestConfig = {
        method: "POST",
        url: `${route}/estrutura`,
        withCredentials: true,
...
export function criarEstruturaModulacao(obj: DMontadorEstruturaPaiModulacao) {
    const config: AxiosRequestConfig = {
        method: "POST",
        url: `${route}/estruturamodulacao`,
        withCredentials: true,
        data: obj
    }
...
export function atualizar(obj: DPai) {
    const config: AxiosRequestConfig = {
        method: "PUT",
        url: `${route}`,
        withCredentials: true,
