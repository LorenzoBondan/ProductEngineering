...
import PolyethyleneRow from "../PolyethyleneRow";
            ...
            <div className="crud-content-container">
                <div className="crud-bar-container">
                    <button className="btn btn-primary btn-crud-add" style={{color:"white", marginBottom:"20px"}} onClick={openModal}>
                        Adicionar novo Polietileno
                    </button>
                    <PolyethyleneModal isOpen={modalIsOpen} isEditing={false} onClose={closeModal} onDeleteOrEdit={() => getPolyethylenes()} />
                </div>
                    ...
                    <table className='crud-table'>
                        ...
                        <tbody>
                            {page?.content.map((item) => (
                                <PolyethyleneRow Polyethylene={item} onDeleteOrEdit={getPolyethylenes} key={item.code}/>
                            ))}
                        </tbody>
                    </table>
                </div>
