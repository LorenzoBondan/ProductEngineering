...
public class CrudMaterialImpl implements CrudMaterial {
    ...
    public Paged<DMaterial> buscar(PageableRequest request) {
        ...
        Specification<Material> specification = helper.buildSpecification(request.getColumns(), request.getOperations(), request.getValues());
    ...
    @Override
    public List<DMaterial> pesquisarPorDescricao(String descricao) {
    ...
    @Override
    public DMaterial incluir(DMaterial obj) {
