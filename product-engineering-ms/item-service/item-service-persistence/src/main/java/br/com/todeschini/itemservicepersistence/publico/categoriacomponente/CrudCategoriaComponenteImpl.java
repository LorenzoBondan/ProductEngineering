...
public class CrudCategoriaComponenteImpl implements CrudCategoriaComponente {
    ...
    public Paged<DCategoriaComponente> buscar(PageableRequest request) {
        ...
        Specification<CategoriaComponente> specification = helper.buildSpecification(request.getColumns(), request.getOperations(), request.getValues());
    ...
    @Override
    public List<DCategoriaComponente> pesquisarPorDescricao(String descricao) {
    ...
    @Override
    public DCategoriaComponente incluir(DCategoriaComponente obj) {
