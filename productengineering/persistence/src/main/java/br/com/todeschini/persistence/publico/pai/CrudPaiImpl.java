...
public class CrudPaiImpl implements CrudPai {
    ...
    public CrudPaiImpl(PaiRepository repository, PaiQueryRepository queryRepository, PaiDomainToEntityAdapter adapter, EntityService entityService, PageRequestUtils pageRequestUtils, HistoryService historyService, SituacaoFilter<Pai> situacaoFilter, AuditoriaService auditoriaService) {
