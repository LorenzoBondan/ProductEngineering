...
import br.com.todeschini.domain.business.processadores.ChapaMDPProcessador;
...
public class ChapaMDPProcessadorImpl implements ChapaMDPProcessador {
    ...
    public ChapaMDPProcessadorImpl(ChapaQueryRepository queryRepository, ChapaDomainToEntityAdapter adapter, MaterialUsadoService materialUsadoService) {
