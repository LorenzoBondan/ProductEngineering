...
public class CrudCorImpl implements CrudCor {
    ...
    public CrudCorImpl(CorRepository repository, CorQueryRepository queryRepository, CorDomainToEntityAdapter adapter, EntityService entityService,
                       PageRequestUtils pageRequestUtils, HistoryService historyService, SituacaoFilter<Cor> situacaoFilter, AuditoriaService auditoriaService) {
    ...
    @Override
    public Collection<DCor> pesquisarPorDescricao(String descricao) {
