...
public class CrudFilhoImpl implements CrudFilho {
    ...
    public CrudFilhoImpl(FilhoRepository repository, FilhoQueryRepository queryRepository, FilhoDomainToEntityAdapter adapter, EntityService entityService,
                         PageRequestUtils pageRequestUtils, HistoryService historyService, SituacaoFilter<Filho> situacaoFilter, AuditoriaService auditoriaService) {
    ...
    @Override
    public Collection<DFilho> pesquisarPorDescricaoECorEMedidas(String descricao, Integer cdcor, Integer cdmedidas) {
