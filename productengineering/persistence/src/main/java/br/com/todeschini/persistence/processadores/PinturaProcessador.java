...
@Component
public class PinturaProcessador implements MaterialProcessador {
    ...
    public PinturaProcessador(PinturaQueryRepository queryRepository, PinturaDomainToEntityAdapter adapter, MaterialUsadoService materialUsadoService) {
