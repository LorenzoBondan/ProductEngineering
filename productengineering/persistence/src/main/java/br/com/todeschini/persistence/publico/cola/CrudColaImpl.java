...
public class CrudColaImpl implements CrudCola {
    ...
    public CrudColaImpl(ColaRepository repository, ColaQueryRepository queryRepository, ColaDomainToEntityAdapter adapter, EntityService entityService,
                        PageRequestUtils pageRequestUtils, HistoryService historyService, SituacaoFilter<Cola> situacaoFilter) {
    ...
    @Override
    @Transactional(readOnly = true)
    public Collection<? extends DCola> pesquisarPorDescricao(String descricao) {
    ...
    private void setCreationProperties(Cola obj){
