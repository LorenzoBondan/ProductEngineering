...
public class CrudPinturaBordaFundoImpl implements CrudPinturaBordaFundo {
    ...
    private final SituacaoFilter<PinturaBordaFundo> situacaoFilter;
    ...
    public CrudPinturaBordaFundoImpl(PinturaBordaFundoRepository repository, PinturaBordaFundoQueryRepository queryRepository, PinturaBordaFundoDomainToEntityAdapter adapter, EntityService entityService,
                                     PageRequestUtils pageRequestUtils, HistoryService historyService, SituacaoFilter<PinturaBordaFundo> situacaoFilter, AuditoriaService auditoriaService) {
    ...
    @Override
    public Collection<DPinturaBordaFundo> pesquisarPorDescricao(String descricao) {
