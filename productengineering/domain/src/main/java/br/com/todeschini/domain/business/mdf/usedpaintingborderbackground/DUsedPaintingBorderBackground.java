...
@Setter
@NoArgsConstructor
public class DUsedPaintingBorderBackground extends DBaseUsedMaterial {

    private Long paintingBorderBackgroundCode;
    private Long paintingSonCode;

    public DUsedPaintingBorderBackground(Long id){
        this.setId(id);
    }
    ...
    public void validate(){
        ...
        new ValidationBuilder()
                ...
                .add(new NamedValidator<>("Código da Pintura de Borda", new ObjetoNaoNuloValidator()), this.paintingBorderBackgroundCode)
                .add(new NamedValidator<>("Código da Pintura de Borda", new NumeroMaiorQueZeroValidator()), this.paintingBorderBackgroundCode)
                .validate();
    }
}
