package br.com.todeschini.domain.business.publico.pinturausada;
...
@NoArgsConstructor
@Domain
public class DPinturaUsada extends DMaterialUsado implements Descritivel  {

    public DPinturaUsada(Integer codigo){
