...
import br.com.todeschini.persistence.publico.son.CrudSonImpl;
...
public class SonControllerIT extends BaseControllerIT<DSon> {

    @MockBean
    private CrudSonImpl crud;
    @MockBean
    private SonRepository repository;

    @BeforeEach
    void setUp() throws Exception {
        setConfiguration("/sons");

        factoryObject = SonFactory.createDSon();
        duplicatedObject = SonFactory.createDuplicatedDSon();
        nonExistingObject = SonFactory.createNonExistingDSon(nonExistingId);
