...
import br.com.todeschini.webapi.api.v1.rest.guides.guide.GuideController;
...
public class GuideControllerTests {
    ...
    private final GuideService service = mock(GuideService.class);
    private final GuideRepository repository = mock(GuideRepository.class);
    private final GuideController controller = new GuideController(service, repository);

    private DGuide object, nonExistingObject;
    private Long existingId, nonExistingId;
    private String description;
    private final List<Status> statusList = new ArrayList<>();
    private final List<DGuide> objectList = new ArrayList<>();
    ...
    void setUp() {
        ...
        // insert
        when(service.insert(any(DGuide.class))).thenReturn(object);

        // update
        when(service.update(eq(existingId), any(DGuide.class))).thenReturn(object);
    ...
    public void findByIdShouldReturnObjectWhenIdExists() {
        ...
        // Verificando o tipo de dado e código de status
        assertThat(responseEntity.getBody()).isInstanceOf(DGuide.class);
        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
