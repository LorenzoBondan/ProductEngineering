...
import br.com.todeschini.persistence.mdf.paintingtype.CrudPaintingTypeImpl;
...
public class PaintingTypeControllerIT extends BaseControllerIT<DPaintingType> {

    @MockBean
    private CrudPaintingTypeImpl crud;
    @MockBean
    private PaintingTypeRepository repository;

    @BeforeEach
    void setUp() throws Exception {
        setConfiguration("/paintingTypes");

        factoryObject = PaintingTypeFactory.createDPaintingType();
        duplicatedObject = PaintingTypeFactory.createDuplicatedDPaintingType();
        nonExistingObject = PaintingTypeFactory.createNonExistingDPaintingType(nonExistingId);
