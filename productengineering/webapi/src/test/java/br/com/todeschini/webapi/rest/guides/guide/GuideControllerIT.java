...
import br.com.todeschini.persistence.guides.guide.CrudGuideImpl;
...
public class GuideControllerIT extends BaseControllerIT<DGuide> {

    @MockBean
    private CrudGuideImpl crud;
    @MockBean
    private GuideRepository repository;

    @BeforeEach
    void setUp() throws Exception {
        setConfiguration("/guides");

        factoryObject = GuideFactory.createDGuide();
        duplicatedObject = GuideFactory.createDuplicatedDGuide();
        nonExistingObject = GuideFactory.createNonExistingDGuide(nonExistingId);
    ...
    public void validationShouldThrowUnprocessableEntityWhenInvalidDataTest() throws Exception {
        factoryObject = GuideFactory.createDGuide();
        factoryObject.setImplementation(null);
        ...
        factoryObject = GuideFactory.createDGuide();
        factoryObject.setFinalDate(null);
        validate(factoryObject);
