...
import br.com.todeschini.persistence.mdf.paintingson.CrudPaintingSonImpl;
...
public class PaintingSonControllerIT extends BaseControllerIT<DPaintingSon> {

    @MockBean
    private CrudPaintingSonImpl crud;
    @MockBean
    private PaintingSonRepository repository;

    @BeforeEach
    void setUp() throws Exception {
        setConfiguration("/paintingSons");

        factoryObject = PaintingSonFactory.createDPaintingSon();
        duplicatedObject = PaintingSonFactory.createDuplicatedDPaintingSon();
        nonExistingObject = PaintingSonFactory.createNonExistingDPaintingSon(nonExistingId);
    ...
    public void validationShouldThrowUnprocessableEntityWhenInvalidDataTest() throws Exception {
        ...
        factoryObject = PaintingSonFactory.createDPaintingSon();
        factoryObject.setSpecial(null);
        validate(factoryObject);

        factoryObject = PaintingSonFactory.createDPaintingSon();
        factoryObject.setSatin(null);
        validate(factoryObject);

        factoryObject = PaintingSonFactory.createDPaintingSon();
        factoryObject.setHighShine(null);
        validate(factoryObject);

        factoryObject = PaintingSonFactory.createDPaintingSon();
        factoryObject.setSatinGlass(null);
        validate(factoryObject);
