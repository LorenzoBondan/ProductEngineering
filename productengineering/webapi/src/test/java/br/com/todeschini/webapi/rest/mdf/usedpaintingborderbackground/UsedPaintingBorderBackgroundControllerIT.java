...
import br.com.todeschini.persistence.mdf.usedpaintingborderbackground.CrudUsedPaintingBorderBackgroundImpl;
...
public class UsedPaintingBorderBackgroundControllerIT extends BaseControllerIT<DUsedPaintingBorderBackground> {

    @MockBean
    private CrudUsedPaintingBorderBackgroundImpl crud;
    @MockBean
    private UsedPaintingBorderBackgroundRepository repository;

    @BeforeEach
    void setUp() throws Exception {
        setConfiguration("/usedPaintingBorderBackgrounds");

        Long duplicatedId = 2L;

        factoryObject = UsedPaintingBorderBackgroundFactory.createDUsedPaintingBorderBackground();
        duplicatedObject = UsedPaintingBorderBackgroundFactory.createDuplicatedDUsedPaintingBorderBackground(duplicatedId);
        nonExistingObject = UsedPaintingBorderBackgroundFactory.createNonExistingDUsedPaintingBorderBackground(nonExistingId);
        ...
        // custom duplicated
        doThrow(DuplicatedResourceException.class).when(crud).findByPaintingBorderBackgroundAndPaintingSon(duplicatedId, duplicatedId);
    }
    ...
    public void validationShouldThrowUnprocessableEntityWhenInvalidDataTest() throws Exception {
        ...
        factoryObject = UsedPaintingBorderBackgroundFactory.createDUsedPaintingBorderBackground();
        factoryObject.setPaintingBorderBackgroundCode(null);
        validate(factoryObject);

        factoryObject = UsedPaintingBorderBackgroundFactory.createDUsedPaintingBorderBackground();
        factoryObject.setPaintingBorderBackgroundCode(ValidationConstants.longNegative);
        validate(factoryObject);
