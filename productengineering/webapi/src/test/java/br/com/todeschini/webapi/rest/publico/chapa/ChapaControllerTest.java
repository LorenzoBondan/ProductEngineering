...
public class ChapaControllerTest extends BaseControllerTest<DChapa, Chapa> {
    ...
    @Autowired
    public ChapaControllerTest(MockMvc mockMvc, ObjectMapper objectMapper, HistoryRepository historyRepository, TokenUtil tokenUtil) {
    ...
    @BeforeAll
    public void setUp() {
        novaEntidade = ChapaFactory.createDChapa();
        novaEntidade.setCodigo(null);
        super.setHasDescricao(true);
    }

    @Override
    protected Class<Chapa> getEntityClass() {
        return Chapa.class;
    }

    @Override
    protected String getDescricao(DChapa entidade) {
        return entidade.getDescricao();
    }

    @Override
    protected void setCodigo(DChapa entidade, Integer codigo) {
        entidade.setCodigo(codigo);
    }

    @Override
    protected void setDescricao(DChapa entidade, String descricao) {
    ...
    void tearDown() {
        if (idCriado != null) {
            chapaRepository.deleteById(idCriado);
