package br.com.todeschini.webapi.api.v1.rest.publico.pintura;
...
@Tag(name = "Pintura")
@RestController
@RequestMapping("/api/pintura")
public class PinturaController {

    private final PinturaService service;

    public PinturaController(PinturaService service) {
     ...
     */
    @Operation(summary = "Pesquisar todas as Pinturas por colunas, operações e valores", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param codigo representa o ID da Pintura a ser pesquisada
     */
    @Operation(summary = "Pesquisar uma lista de versões de uma Pintura por id", method = "GET", description = "Pesquisa uma lista de versões por id, independente da sua situação")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden")
    ...
    @Operation(summary = "Pesquisar uma lista de atributos da Pintura que podem ser editados em lote", method = "GET")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden")
    ...
    /**
     * @param dto representa o objeto Pintura a ser criado
     */
    @Operation(summary = "Inserir uma nova Pintura", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> criar(
            @RequestBody
            @Schema(
                    description = "Objeto de Pintura para criação",
                    requiredProperties = "descricao, tipoMaterial.codigo, porcentagemPerda, valor, tipoPintura",
                    example = """
                    {
                        "descricao": "Descrição",
                        "tipoMaterial": {
    ...
    /**
     * @param dto representa o objeto Pintura a ser atualizado
     */
    @Operation(summary = "Atualizar uma Pintura", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> atualizar(
            @RequestBody
            @Schema(
                    description = "Objeto de Pintura para edição",
                    requiredProperties = "codigo, descricao, tipoMaterial.codigo, porcentagemPerda, valor, tipoPintura",
                    example = """
                    {
                        "codigo": 1,
                        "descricao": "Descrição",
    ...
    /**
     *
     * @param codigos códigos das Pinturas a serem editadas
     * @param atributos nomes dos atributos a serem editados
     * @param valores valores dos atributos a serem editados
     */
    @Operation(summary = "Atualizar uma lista de Pinturas", method = "PUT", description = "Atualiza o(s) atributo(s) de todos os objetos da lista")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    /**
     * @param codigoRegistro código da Pintura a ser substituída
     * @param codigoVersao código do t_history com a versão a ser utilizada
     */
    @Operation(summary = "Substituir uma Pintura por uma versão anterior", method = "PUT", description = "O objeto tem seus campos alterados para uma versão anterior")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden"),
    ...
    /**
     * @param codigos lista dos códigos das Pinturas a serem inativadas
     */
    @Operation(summary = "Inativar uma lista de Pinturas", method = "PATCH", description = "A situação dos objetos é alterada para 'Inativo'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
    ...
    /**
     * @param codigos lista dos códigos das Pinturas a serem excluídas
     */
    @Operation(summary = "Excluir uma lista de Pinturas", method = "DELETE", description = "A situação dos objetos é alterada para 'Lixeira'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "206", description = "Partial content"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
