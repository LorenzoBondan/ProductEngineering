...
public class MaterialUsadoController {
    ...
    /**
     * @param codigo representa o código do Material Usado a ser pesquisado
     */
    @Operation(summary = "Pesquisar todos os Materiais Usados ativos mais o atual", method = "GET", description = "Utilizável para popular comboboxes, pesquisa todas as objetos com situação 'Ativo' mais o objeto passado como parâmetro (independente de sua situação)")
    @ApiResponses(value = {
