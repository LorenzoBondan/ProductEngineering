...
@Tag(name = "MDPSons")
@RestController
@RequestMapping(value = "/mdpSons")
public class MDPSonController {
    ...
    public ResponseEntity<?> findByStatusInAndDescriptionContainingIgnoreCase(@RequestBody(required = false) List<Status> statusList,
        ...
        return ResponseEntity.ok().body(repository.findByStatusInAndDescriptionContainingIgnoreCase(statusList, description, pageable, MDPSonDTO.class));
    }
