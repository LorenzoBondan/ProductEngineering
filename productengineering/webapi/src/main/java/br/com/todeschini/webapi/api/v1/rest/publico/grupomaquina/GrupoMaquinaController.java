...
public class GrupoMaquinaController {
    ...
    /**
     * @param codigo representa o código do GrupoMaquina a ser pesquisada
     */
    @Operation(summary = "Pesquisar todos os Grupo Máquinas ativos mais o atual", method = "GET", description = "Utilizável para popular comboboxes, pesquisa todas as objetos com situação 'Ativo' mais o objeto passado como parâmetro (independente de sua situação)")
    @ApiResponses(value = {
