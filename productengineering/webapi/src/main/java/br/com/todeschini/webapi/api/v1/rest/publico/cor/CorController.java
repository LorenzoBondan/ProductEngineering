package br.com.todeschini.webapi.api.v1.rest.publico.cor;
...
public class CorController {
     ...
     */
    @Operation(summary = "Pesquisar todas as Cores por colunas, operações e valores", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param codigo representa o código da Cor a ser pesquisada
     */
    @Operation(summary = "Pesquisar todas as Cores ativas mais a atual", method = "GET", description = "Utilizável para popular comboboxes, pesquisa todas as objetos com situação 'Ativo' mais o objeto passado como parâmetro (independente de sua situação)")
    @ApiResponses(value = {
    ...
    /**
     * @param id representa o ID da Cor a ser pesquisada
     */
    @Operation(summary = "Pesquisar uma Cor por id", method = "GET", description = "Pesquisa um objeto por id, independente da sua situação")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden"),
    ...
    /**
     * @param codigo representa o ID da Cor a ser pesquisada
     */
    @Operation(summary = "Pesquisar uma lista de versões de uma Cor por id", method = "GET", description = "Pesquisa uma lista de versões por id, independente da sua situação")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden")
    ...
    /**
     * @param dto representa o objeto Cor a ser criado
     */
    @Operation(summary = "Inserir uma nova Cor", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> criar(
            @RequestBody
            @Schema(
                    description = "Objeto de Cor para criação",
    ...
    /**
     * @param dto representa o objeto Cor a ser atualizado
     */
    @Operation(summary = "Atualizar uma Cor", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> atualizar(
            @RequestBody
            @Schema(
                    description = "Objeto de Cor para edição",
    ...
    /**
     * @param codigoRegistro código da Cor a ser substituída
     * @param codigoVersao código do t_history com a versão a ser utilizada
     */
    @Operation(summary = "Substituir uma Cor por uma versão anterior", method = "PUT", description = "O objeto tem seus campos alterados para uma versão anterior")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden"),
    ...
    /**
     * @param codigos lista dos códigos das Cores a serem inativadas
     */
    @Operation(summary = "Inativar uma lista de Cores", method = "PATCH", description = "A situação dos objetos é alterada para 'Inativo'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
    ...
    /**
     * @param codigos lista dos códigos das Cores a serem excluídas
     */
    @Operation(summary = "Excluir uma lista de Cores", method = "DELETE", description = "A situação dos objetos é alterada para 'Lixeira'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "206", description = "Partial content"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
