...
public class ChapaController {
    ...
    /**
     * @param codigo representa o código da Chapa a ser pesquisada
     */
    @Operation(summary = "Pesquisar todas as Chapas ativas mais a atual", method = "GET", description = "Utilizável para popular comboboxes, pesquisa todas as objetos com situação 'Ativo' mais o objeto passado como parâmetro (independente de sua situação)")
    @ApiResponses(value = {
