package br.com.todeschini.webapi.api.v1.rest.publico.baguete;
...
@Tag(name = "Baguete")
@RestController
@RequestMapping("/api/baguete")
public class BagueteController {

    private final BagueteService service;

    public BagueteController(BagueteService service) {
     ...
     */
    @Operation(summary = "Pesquisar todas as Baguetes por colunas, operações e valores", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param codigo representa o código da Baguete a ser pesquisada
     */
    @Operation(summary = "Pesquisar todas as Baguetes ativas mais a atual", method = "GET", description = "Utilizável para popular comboboxes, pesquisa todas as objetos com situação 'Ativo' mais o objeto passado como parâmetro (independente de sua situação)")
    @ApiResponses(value = {
    ...
    /**
     * @param id representa o ID da Baguete a ser pesquisada
     */
    @Operation(summary = "Pesquisar uma Baguete por id", method = "GET", description = "Pesquisa um objeto por id, independente da sua situação")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden"),
    ...
    /**
     * @param codigo representa o ID da Baguete a ser pesquisada
     */
    @Operation(summary = "Pesquisar uma lista de versões de uma Baguete por id", method = "GET", description = "Pesquisa uma lista de versões por id, independente da sua situação")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden")
    ...
    @Operation(summary = "Pesquisar uma lista de atributos da Baguete que podem ser editados em lote", method = "GET")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden")
    ...
    /**
     * @param dto representa o objeto Baguete a ser criado
     */
    @Operation(summary = "Inserir uma nova Baguete", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> criar(
            @RequestBody
            @Schema(
                    description = "Objeto de Baguete para criação",
    ...
    /**
     * @param dto representa o objeto Baguete a ser atualizado
     */
    @Operation(summary = "Atualizar uma Baguete", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> atualizar(
            @RequestBody
            @Schema(
                    description = "Objeto de Baguete para edição",
    ...
    /**
     *
     * @param codigos códigos das Baguetes a serem editadas
     * @param atributos nomes dos atributos a serem editados
     * @param valores valores dos atributos a serem editados
     */
    @Operation(summary = "Atualizar uma lista de Baguetes", method = "PUT", description = "Atualiza o(s) atributo(s) de todos os objetos da lista")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    /**
     * @param codigoRegistro código da Baguete a ser substituída
     * @param codigoVersao código do t_history com a versão a ser utilizada
     */
    @Operation(summary = "Substituir uma Baguete por uma versão anterior", method = "PUT", description = "O objeto tem seus campos alterados para uma versão anterior")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden"),
    ...
    /**
     * @param codigos lista dos códigos das Baguetes a serem inativadas
     */
    @Operation(summary = "Inativar uma lista de Baguetes", method = "PATCH", description = "A situação dos objetos é alterada para 'Inativo'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
    ...
    /**
     * @param codigos lista dos códigos das Baguetes a serem excluídas
     */
    @Operation(summary = "Excluir uma lista de Baguetes", method = "DELETE", description = "A situação dos objetos é alterada para 'Lixeira'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "206", description = "Partial content"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
