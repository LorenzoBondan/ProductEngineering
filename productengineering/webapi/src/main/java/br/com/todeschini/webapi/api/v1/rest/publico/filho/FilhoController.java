package br.com.todeschini.webapi.api.v1.rest.publico.filho;
...
public class FilhoController {
    ...
    public FilhoController(FilhoService service) {
     ...
     */
    @Operation(summary = "Pesquisar todos os Filhos por colunas, operações e valores", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param codigo representa o código do Filho a ser pesquisado
     */
    @Operation(summary = "Pesquisar todos os Filhos ativos mais o atual", method = "GET", description = "Utilizável para popular comboboxes, pesquisa todas as objetos com situação 'Ativo' mais o objeto passado como parâmetro (independente de sua situação)")
    @ApiResponses(value = {
    ...
    /**
     * @param id representa o ID do Filho a ser pesquisado
     */
    @Operation(summary = "Pesquisar um Filho por id", method = "GET", description = "Pesquisa um objeto por id, independente da sua situação")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden"),
    ...
    /**
     * @param codigo representa o ID do Filho a ser pesquisado
     */
    @Operation(summary = "Pesquisar uma lista de versões de um Filho por id", method = "GET", description = "Pesquisa uma lista de versões por id, independente da sua situação")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden")
    ...
    @Operation(summary = "Pesquisar uma lista de atributos do Filho que podem ser editados em lote", method = "GET")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden")
    ...
    /**
     * @param dto representa o objeto Filho a ser criado
     */
    @Operation(summary = "Inserir um novo Filho", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> criar(
            @RequestBody
            @Schema(
                    description = "Objeto de Filho para criação",
                    requiredProperties = "descricao, cor.codigo, medidas.codigo",
                    example = """
                    {
                        "descricao": "Descrição",
                        "pai": {
    ...
    /**
     * @param dto representa o objeto Filho a ser atualizado
     */
    @Operation(summary = "Atualizar um Filho", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> atualizar(
            @RequestBody
            @Schema(
                    description = "Objeto de Filho para edição",
                    requiredProperties = "codigo, descricao, cor.codigo, medidas.codigo",
                    example = """
                    {
                        "codigo": 1,
                        "descricao": "Descrição",
    ...
    /**
     *
     * @param codigos códigos dos Filhos a serem editados
     * @param atributos nomes dos atributos a serem editados
     * @param valores valores dos atributos a serem editados
     */
    @Operation(summary = "Atualizar uma lista de Filhos", method = "PUT", description = "Atualiza o(s) atributo(s) de todos os objetos da lista")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    /**
     * @param codigoRegistro código do Filho a ser substituído
     * @param codigoVersao código do t_history com a versão a ser utilizada
     */
    @Operation(summary = "Substituir um Filho por uma versão anterior", method = "PUT", description = "O objeto tem seus campos alterados para uma versão anterior")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden"),
    ...
    /**
     * @param codigos lista dos códigos dos Filhoes a serem inativados
     */
    @Operation(summary = "Inativar uma lista de Filhos", method = "PATCH", description = "A situação dos objetos é alterada para 'Inativo'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
    ...
    /**
     * @param codigos lista dos códigos dos Filhoes a serem excluídos
     */
    @Operation(summary = "Excluir uma lista de Filhos", method = "DELETE", description = "A situação dos objetos é alterada para 'Lixeira'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "206", description = "Partial content"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
