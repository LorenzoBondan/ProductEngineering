package br.com.todeschini.webapi.api.v1.rest.publico.cantoneira;
...
@Tag(name = "Cantoneira")
@RestController
@RequestMapping("/api/cantoneira")
public class CantoneiraController {

    private final CantoneiraService service;

    public CantoneiraController(CantoneiraService service) {
     ...
     */
    @Operation(summary = "Pesquisar todas as Cantoneiras por colunas, operações e valores", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param codigo representa o código da Cantoneira a ser pesquisada
     */
    @Operation(summary = "Pesquisar todas as Cantoneiras ativas mais a atual", method = "GET", description = "Utilizável para popular comboboxes, pesquisa todas as objetos com situação 'Ativo' mais o objeto passado como parâmetro (independente de sua situação)")
    @ApiResponses(value = {
    ...
    /**
     * @param id representa o ID da Cantoneira a ser pesquisada
     */
    @Operation(summary = "Pesquisar uma Cantoneira por id", method = "GET", description = "Pesquisa um objeto por id, independente da sua situação")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden"),
    ...
    /**
     * @param codigo representa o ID da Cantoneira a ser pesquisada
     */
    @Operation(summary = "Pesquisar uma lista de versões de uma Cantoneira por id", method = "GET", description = "Pesquisa uma lista de versões por id, independente da sua situação")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden")
    ...
    @Operation(summary = "Pesquisar uma lista de atributos da Cantoneira que podem ser editados em lote", method = "GET")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden")
    ...
    /**
     * @param dto representa o objeto Cantoneira a ser criado
     */
    @Operation(summary = "Inserir uma nova Cantoneira", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> criar(
            @RequestBody
            @Schema(
                    description = "Objeto de Cantoneira para criação",
    ...
    /**
     * @param dto representa o objeto Cantoneira a ser atualizado
     */
    @Operation(summary = "Atualizar uma Cantoneira", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> atualizar(
            @RequestBody
            @Schema(
                    description = "Objeto de Cantoneira para edição",
    ...
    /**
     *
     * @param codigos códigos das Cantoneiras a serem editadas
     * @param atributos nomes dos atributos a serem editados
     * @param valores valores dos atributos a serem editados
     */
    @Operation(summary = "Atualizar uma lista de Cantoneiras", method = "PUT", description = "Atualiza o(s) atributo(s) de todos os objetos da lista")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    /**
     * @param codigoRegistro código da Cantoneira a ser substituída
     * @param codigoVersao código do t_history com a versão a ser utilizada
     */
    @Operation(summary = "Substituir uma Cantoneira por uma versão anterior", method = "PUT", description = "O objeto tem seus campos alterados para uma versão anterior")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden"),
    ...
    /**
     * @param codigos lista dos códigos das Cantoneiras a serem inativadas
     */
    @Operation(summary = "Inativar uma lista de Cantoneiras", method = "PATCH", description = "A situação dos objetos é alterada para 'Inativo'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
    ...
    /**
     * @param codigos lista dos códigos das Cantoneiras a serem excluídas
     */
    @Operation(summary = "Excluir uma lista de Cantoneiras", method = "DELETE", description = "A situação dos objetos é alterada para 'Lixeira'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "206", description = "Partial content"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
