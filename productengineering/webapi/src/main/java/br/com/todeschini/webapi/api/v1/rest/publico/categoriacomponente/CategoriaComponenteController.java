package br.com.todeschini.webapi.api.v1.rest.publico.categoriacomponente;
...
@Tag(name = "CategoriaComponente")
@RestController
@RequestMapping("/api/categoriacomponente")
public class CategoriaComponenteController {

    private final CategoriaComponenteService service;

    public CategoriaComponenteController(CategoriaComponenteService service) {
     ...
     */
    @Operation(summary = "Pesquisar todas as CategoriaComponentees por colunas, operações e valores", method = "GET")
    @ApiResponses(value = {
    ...
    /**
     * @param codigo representa o código da CategoriaComponente a ser pesquisada
     */
    @Operation(summary = "Pesquisar todas as CategoriaComponentees ativas mais a atual", method = "GET", description = "Utilizável para popular comboboxes, pesquisa todas as objetos com situação 'Ativo' mais o objeto passado como parâmetro (independente de sua situação)")
    @ApiResponses(value = {
    ...
    /**
     * @param id representa o ID da CategoriaComponente a ser pesquisada
     */
    @Operation(summary = "Pesquisar uma CategoriaComponente por id", method = "GET", description = "Pesquisa um objeto por id, independente da sua situação")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden"),
    ...
    /**
     * @param codigo representa o ID da CategoriaComponente a ser pesquisada
     */
    @Operation(summary = "Pesquisar uma lista de versões de uma CategoriaComponente por id", method = "GET", description = "Pesquisa uma lista de versões por id, independente da sua situação")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden")
    ...
    /**
     * @param dto representa o objeto CategoriaComponente a ser criado
     */
    @Operation(summary = "Inserir uma nova CategoriaComponente", method = "POST")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> criar(
            @RequestBody
            @Schema(
                    description = "Objeto de CategoriaComponente para criação",
            ...
            DCategoriaComponente dto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.incluir(dto));
    }

    /**
     * @param dto representa o objeto CategoriaComponente a ser atualizado
     */
    @Operation(summary = "Atualizar uma CategoriaComponente", method = "PUT")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "400", description = "Bad Request"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    public ResponseEntity<?> atualizar(
            @RequestBody
            @Schema(
                    description = "Objeto de CategoriaComponente para edição",
    ...
    /**
     * @param codigoRegistro código da CategoriaComponente a ser substituída
     * @param codigoVersao código do t_history com a versão a ser utilizada
     */
    @Operation(summary = "Substituir uma CategoriaComponente por uma versão anterior", method = "PUT", description = "O objeto tem seus campos alterados para uma versão anterior")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden"),
    ...
    /**
     * @param codigos lista dos códigos das CategoriaComponentees a serem inativadas
     */
    @Operation(summary = "Inativar uma lista de CategoriaComponentees", method = "PATCH", description = "A situação dos objetos é alterada para 'Inativo'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
    ...
    /**
     * @param codigos lista dos códigos das CategoriaComponentees a serem excluídas
     */
    @Operation(summary = "Excluir uma lista de CategoriaComponentees", method = "DELETE", description = "A situação dos objetos é alterada para 'Lixeira'")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok"),
            @ApiResponse(responseCode = "206", description = "Partial content"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
