package br.com.todeschini.webapi.api.v1.rest.mdf.paintingborderbackground;
...
@Tag(name = "PaintingBorderBackgrounds")
@RestController
@RequestMapping(value = "/paintingBorderBackgrounds")
public class PaintingBorderBackgroundController {

    private final PaintingBorderBackgroundService service;
    private final PaintingBorderBackgroundRepository repository;

    public PaintingBorderBackgroundController(PaintingBorderBackgroundService service, PaintingBorderBackgroundRepository repository) {
    ...
    public ResponseEntity<?> findByStatusInAndDescriptionContainingIgnoreCase(@RequestParam(value = "status", required = false) String statusParam,
        ...
        return ResponseEntity.ok().body(repository.findByStatusInAndDescriptionContainingIgnoreCase(statusList, description, pageable, PaintingBorderBackgroundDTO.class));
    }
    ...
    public ResponseEntity<List<DPaintingBorderBackground>> findAllActiveAndCurrentOne(@RequestParam(value = "id", required = false) Long id){
        List<DPaintingBorderBackground> list = service.findAllActiveAndCurrentOne(id);
    ...
    @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_ANALYST', 'ROLE_OPERATOR')")
    @GetMapping(value = "/{id}")
    public ResponseEntity<DPaintingBorderBackground> findById(@PathVariable Long id){
        DPaintingBorderBackground dto = service.find(id);
    ...
    @PostMapping
    public ResponseEntity<DPaintingBorderBackground> insert(@Valid @RequestBody DPaintingBorderBackground dto){
    ...
    @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_ANALYST')")
    @PutMapping(value = "/{id}")
    public ResponseEntity<DPaintingBorderBackground> update(@PathVariable Long id, @Valid @RequestBody DPaintingBorderBackground dto){
    ...
    public ResponseEntity<DPaintingBorderBackground> inactivate(@PathVariable Long id){
    ...
    public ResponseEntity<DPaintingBorderBackground> delete(@PathVariable Long id){
        service.delete(id);
